<x-app-layout>
    <div class="max-w-7xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
        <div class="m-4">
            <a href="{{ route('trafficAccident.create') }}" class="inline-block py-2 px-4 text-black border-2 rounded-xl border-gray-500 font-bold bg-blue-200 text-decoration-none shadow">
                {{ __('事故登録する') }}
            </a>

            <a href="{{ route('mytrafficaccidents') }}" class="text-black border-gray-500 border-2 rounded-xl font-bold inline-block ml-8 py-2 px-4 bg-blue-200 text-decoration-none shadow">
                {{ __('登録した事故を確認する') }}
            </a>
        </div>
